# Blog Profile Checklist

## Site Identity

* Site title: **Tom's AI Lab**
* Subtitle (short tagline): **Building My Own Digital Workforce**
* Short description (1-2 sentences for SEO): **A personal log of building AI employees to solve real-world research and engineering problems. Exploring Agent Memory, Cognition, and Human-AI collaboration.**
...
* Blog title shown in nav (leave blank to use site title): **Tom's Lab**
* Menu items (label + link):
1. **首页** ( / )
2. **归档** ( /archives/ )  <-- *记录你的时间线*
3. **分类** ( /categories/ ) <-- *区分 "Engineering" 和 "Research"*
4. **标签** ( /tags/ )       <-- *区分具体技术栈，如 "LangChain", "RAG"*
5. **关于** ( /about/ )      <-- *你的个人宣言和 Roadmap*
...
* Footer HTML (optional, plain text ok): **Building in public. Powered by Hexo & Fluid.**
* Show PV/UV stats (yes/no): **yes**
* Stats source (busuanzi/leancloud/umami): **busuanzi** *(配置最简单，不用后端)*
* ICP record (if applicable):
* Enable (yes/no): **no** *(使用 Vercel 部署通常不需要 ICP，且不显示更简洁)*
* ICP text:
* Police text:
* Police code:
* Police icon path: