---
name: deep-research
description: Conduct systematic, multi-angle research for blog writing and other knowledge-intensive tasks. Use when there is a need to research technologies, products, markets, papers, trends, viewpoints, or other topics.
---

# Deep Research Skill
## Overview

Use a systematic methodology to research a market from multiple angles, depths, and sources.
...
For every deep-research run: Save the complete research report as `.atectix/deepresearch/<YYYYMMDD-HHMMSS>-<topic-slug>.md`.
