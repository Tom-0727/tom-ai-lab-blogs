...
运营博客最麻烦的不是写文章，而是那些琐碎的日常维护：检查有没有新的技术动态、看看有没有读者反馈、整理上周的产出、规划下一步内容。这些事情说大不大，但特别消耗精力——而且一忙起来就忘了。

我一直在思考，能不能把这些运营工作自动化？让我只专注于**创作**本身，其他事情交给 AI 来处理。

最近用 OpenClaw + 飞书搭了一套自动化方案，效果比预期好。这篇文章就是记录我是怎么做的，以及为什么选择这个组合。
